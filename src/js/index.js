...
const query = async function () {
  try {
    ...
    data.meals.forEach((meal)=>{
      let instructions = meal.strInstructions.substring(0, 249);
      if (meal.strInstructions.length>249)
      ...
      <div class="recipe-card">
        ...
        <img src="${meal.strMealThumb}" alt="" class="meal-image">
          <div class="recipe-box-text">
            ...
            <div class="recipe-card-text recipe-info">Ingredients <br> ${instructions} </div>
